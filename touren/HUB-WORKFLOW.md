...
| Fotos **oben** | Nicht alle Bilder gehören nach unten: `galerie-einbauen.py` zieht je nach Menge ein bis zwei Kacheln nach oben zwischen die Zahlen — neben das Höhenprofil (aus dem Aufstieg) und in den freien Platz neben der Karte (der Überblick). Das Raster hatte den Platz schon: die Karte belegt 8 von 12 Spalten, 4 standen leer. **Ab 6 Fotos → 2 hoch · 3–5 → 1 · bis 2 → keins** (zwei sind das Minimum für ein Paar in der Strecke). |
